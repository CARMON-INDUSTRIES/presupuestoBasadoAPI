...
namespace presupuestoBasadoAPI.Migrations
{
    ...
    [Migration("20260526181036_Restauracion")]
            ...
            modelBuilder.Entity("MetaProgramada", b =>
                {
                    ...
                    b.Property<int>("IndicadorDetalleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MetaProgramada", b =>
                {
                    ...
                    b.HasOne("IndicadorDetalle", "IndicadorDetalle")
                        .WithMany("MetasProgramadas")
                        .HasForeignKey("IndicadorDetalleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FichaIndicador");

                    b.Navigation("IndicadorDetalle");
                });
